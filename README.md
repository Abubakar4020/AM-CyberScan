...
Detects suspicious indicators and provides an assessment of whether the URL is safe or unsafe.

Displays results in a graphical format, showing risk levels as percentages for clear understanding.
...
Provides a detailed analysis and determines if a file is safe or unsafe.

Includes report export and history tracking.
...
Simple and intuitive GUI, making cybersecurity tools accessible to everyone.

Combines URL scanning and file scanning in one platform.

Generates exportable reports and maintains scan history for better tracking.
...
File Scanning: Upload files → Tool scans for malware, viruses, and suspicious activity → Displays results visually with safe/unsafe status.
